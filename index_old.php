...
<?php
$tt_b10 = microtime(false);
$ttint_b10 = (int)($tt_b10*1e8);
$tt = base_convert($tt_b10, 10, 36);
$ttint_b36 = base_convert($ttint_b10, 10, 36);
echo '<p> Base convert: '.$tt.' and '.$tt_b10.'</p>';
echo '<p> Base convert: '.$ttint_b10.' and '.$ttint_b36.'</p>';

$truc = base_convert($ttint_b36, 36, 10);
echo '<p> Base revert: '.$truc.'</p>';
?>
