...
require_once(__DIR__.'/get_spreadsheets.php');
...
function downgrade_spreadsheet_rank($account_id_arg, $spreadsheet_id_arg)
{
	$db = get_db();
	...
	$all_spreadsheets = get_spreadsheets($account_id);
	$n_spreadsheets = (int)count($all_spreadsheets);
	$rank_max = $n_spreadsheets - 1;
