...
function create_new_account($hashid_arg, $hashid_admin_arg, $title_of_account_arg, $author_arg, $contact_email_arg, $description_arg ="")
{
	$db = get_db();
	...
	try
	{
		$myquery = 'INSERT INTO '.TABLE_ACCOUNTS.'(id, hashid, hashid_admin, title, author, email, description) 
		VALUES(NULL, :hashid, :hashid_admin, :title, :author, :email, :description)';
